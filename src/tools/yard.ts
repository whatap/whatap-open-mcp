...
const PROBE_CATEGORIES: Array<{
  ...
  // DB counter categories — use *_counter (real-time, ~5s interval) instead of
  // *_sqlstat (5-min interval) which falls outside the 2-min probe window.
  { name: "db_oracle_counter", loadType: "TAGLOAD", label: "Oracle" },
  { name: "db_oracle_dma_counter", loadType: "TAGLOAD", label: "Oracle DMA" },
  { name: "db_mysql_counter", loadType: "TAGLOAD", label: "MySQL" },
  { name: "db_postgresql_counter", loadType: "TAGLOAD", label: "PostgreSQL" },
  { name: "db_mssql_counter", loadType: "TAGLOAD", label: "MSSQL" },
  { name: "db_db2_counter", loadType: "TAGLOAD", label: "DB2" },
  { name: "db_sap_ase_counter", loadType: "TAGLOAD", label: "SAP ASE" },
  { name: "db_cubrid_counter", loadType: "TAGLOAD", label: "CUBRID" },
  { name: "db_redis_counter", loadType: "TAGLOAD", label: "Redis" },
  { name: "db_altibase_counter", loadType: "TAGLOAD", label: "Altibase" },
